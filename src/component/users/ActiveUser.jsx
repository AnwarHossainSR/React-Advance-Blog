                        ...
                        <tr key={item.id}>
                          ...
                          <td>
                            <Link to={"/user/details/" + item.id} key={item.id}>
                              <i className="fa fa-info-circle text-primary mr-2" />
                            </Link>
                            <Link to={"/user/update/" + item.id} key={item.id}>
                              <i className="fa fa-edit text-success" />
                            </Link>
                            <i className="fas ml-2 fa-user-slash nav-icon text-danger" title="Click to Deactive" onClick={() => Deactive(item.id)} style={{ cursor:'pointer' }}/>
                          </td>
                        </tr>
                      ))}
                    </tbody>
